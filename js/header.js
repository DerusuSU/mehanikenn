document.addEventListener("DOMContentLoaded", (event) => {
    class Menu {
        constructor(obj) {
            ...
            if (this.button && this.screen && this.nav && this.contacts_cont) {
                this.init();
            } else {
                ...
                console.log(this.contacts_cont);
            }
        }

        init() {
            this.button.addEventListener("click", this.burgerClick.bind(this)); // Привязываем контекст
    ...
    const menu = new Menu({
        ...
        nav: ".header__nav",
        links: ".header__nav a",
        contacts: ".header__contacts span a, .header__contacts span p",
